...
export default function FileUpload01() {
  ...
  return (
    <div className="flex items-center justify-center p-10">
      <Card
        className="w-full mx-auto max-w-lg bg-background rounded-lg p-0 shadow-md">
        <CardContent className="p-0">
          ...
          <div
            className={cn("px-6 pb-5 space-y-3", uploadedFiles.length > 0 ? "mt-4" : "")}>
              ...
              <Tooltip>
                ...
                <TooltipContent className="py-3 bg-background text-foreground border">
                  <div className="space-y-1">
                    ...
                    <p
                      className="text-muted-foreground dark:text-muted-background text-xs max-w-[200px]">
